...
# This script is used to evaluate the supcon (random attributes) performance of a batch of models on leaveout fold
# The models are trained with different seeds

base_dir=$1
# base_dir like **/fold1 and contains folds like **/fold1/Seed1, **/fold1/Seed2, ...

python main.py batch_zero_shot_random_attr \
    --base_dir $base_dir \
